...
(function(a) {
	a.fn.slide = function(b) {
		return a.fn.slide.defaults = {
			...
			var o = parseInt(c.delayTime);
			var p = parseInt(c.interTime);
			
//			var next = document.getElementById("Next");
//
//			next.onclick = function() {
//				o =parseInt(c.fastTime);
//				p =parseInt(c.fastTime);
//				
//			}
...
//			}
			...
			if(j.children().each(function() {
				...
				case "top":
					...
					break;
				case "left":
					j.wrap('<div class="tempWrap" style="overflow:hidden; position:relative; width:94%"></div>').css({
						width: k * y,
						position: "relative",
						overflow: "hidden",
						padding: "0",
				...
				case "leftLoop":
				case "leftMarquee":
					j.children().clone().appendTo(j).clone().prependTo(j), j.wrap('<div class="tempWrap" style="overflow:hidden; position:relative; width: width:94%"></div>').css({
						width: 3 * k * y,
						position: "relative",
						overflow: "hidden",
						padding: "0",
